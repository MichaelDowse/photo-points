...
void main() {
  group('MainTabScreen Widget Tests', () {
    ...
    testWidgets('shows correct tab labels and icons', (WidgetTester tester) async {
      await tester.pumpWidget(createTestWidget(child: const MainTabScreen()));
      await tester.pump();
    ...
    testWidgets('switches to Map tab when Map tab is tapped', (WidgetTester tester) async {
      await tester.pumpWidget(createTestWidget(child: const MainTabScreen()));
      await tester.pump();
    ...
    testWidgets('maintains state between tab switches using IndexedStack', (WidgetTester tester) async {
      await tester.pumpWidget(createTestWidget(child: const MainTabScreen()));
    ...
    testWidgets('shows correct screen content based on selected tab', (WidgetTester tester) async {
    ...
    testWidgets('bottom navigation bar uses fixed type', (WidgetTester tester) async {
      await tester.pumpWidget(createTestWidget(child: const MainTabScreen()));
      await tester.pump();
