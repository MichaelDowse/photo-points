...
void main() {
  group('PhotoPointsMapScreen', () {
    ...
    testWidgets('should show error widget when app state has error', (WidgetTester tester) async {
    ...
    testWidgets('should show empty state when no photo points have coordinates', (WidgetTester tester) async {
    ...
    testWidgets('should show map when photo points have coordinates', (WidgetTester tester) async {
    ...
    group('Photo Point Filtering', () {
      test('should filter photo points that have coordinates', () {
        ...
        final filteredPoints = photoPoints.where((point) => point.hasLocation).toList();
      ...
      test('should return empty list when no photo points have coordinates', () {
        final photoPoints = [
          TestData.createMockPhotoPoint(
            id: 'test-1',
            latitude: null,
